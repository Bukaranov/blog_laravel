...
{{--            <a class="navbar-brand" href="index.html"><img src="{{ asset('assets/images/logo.svg') }}" alt="Edica"></a>--}}
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    @auth()
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('personal.main.index') }}">Личный Кабенет</a>
                        </li>

                        @if(auth()->user()->isAdmin())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.main') }}">Админ панель</a>
                            </li>
                        @endif
    ...
    <div class="container">
        <div class="row footer-widget-area">
            <div class="col-md-3">
                ...
                <p class="contact-details">hello@.com</p>
