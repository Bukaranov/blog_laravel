                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <td>{{$post->title}}</td>
                                            <td class="d-flex ">
                                                <a href="{{route('admin.post.show', $post->id)}}"><i class="text-dark mr-2 fas fa-eye"></i></a>
                                                <a href="{{route('admin.post.edit', $post->id)}}"><i class="text-success mr-1 fas fa-pen"></i></a>
